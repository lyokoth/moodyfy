    ...
    return (
        <div>
            <div className="github-link">
             <a href="https://github.com/lyokoth/moodyfy"
             >GitHub</a></div>
             <br>
             </br>
        ...
        <p className="about-page">Our app utilizes the Spotify Web API to seamlessly access your playlists and song library. Assuming the user has Spotify Premium, it allowing you to discover new tracks that resonate with your feelings. 
